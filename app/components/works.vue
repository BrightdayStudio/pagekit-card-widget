...
<div v-for="panel in widget.data">hello</div>
    ...
    <div class="uk-form-row">
     ...
     <div class="uk-form-row">
        ...
        <input type="text" class="uk-form-width-large" v-model="widget.data.panel.link" placeholder="Link text">
        <input-link class="uk-form-width-large" v-model="widget.data.panel.url" :link.sync="widget.data.panel.url"> </input-link></div>
    </div>
     </div>
